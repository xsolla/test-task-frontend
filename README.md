...
- The application has to use publicly available [JSON-file](events.json) as a public API GET endpoint (if the file changes, the content of the page has to change as well)
